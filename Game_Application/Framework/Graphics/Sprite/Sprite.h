...
//------------------------------------------------------------------------------
// Overview :
// このクラスは 2D スプライト描画を管理します。
// Initialize() で頂点バッファとインデックスバッファを生成し、
// UV座標・サイズ・変換行列・カラーを更新可能にします。
// Draw() によりテクスチャ付き矩形を描画し、
// UpdateVertexBuffer() によって頂点データを最新状態に反映。
// Transform構造を通じて位置・回転・スケールを行列化し、
// Renderer および ShaderManager と連携して最終描画を実行します。
// 主に UI・背景・2Dエフェクトなど、画面上の平面描画を担います。
//==============================================================================
#ifndef SPRITE_H
#define SPRITE_H
