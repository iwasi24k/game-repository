//==============================================================================
// File        : TitleWhiteBlockPrefab.cpp
//------------------------------------------------------------------------------
// Author      : ix.U
// Created     : 2025-12-05
...
//==============================================================================
#include "pch.h"
#include "TitleWhiteBlockPrefab.h"
...
GameObject* TitleWhiteBlockPrefab::Create(GameObjectManager* mgr) {
...
void TitleWhiteBlockPrefab::Configure(GameObject* obj) {
