//==============================================================================
// File        : TitleBlackBlockPrefab.cpp
//------------------------------------------------------------------------------
// Author      : ix.U
// Created     : 2025-12-05
...
//==============================================================================
#include "pch.h"
#include "TitleBlackBlockPrefab.h"
...
GameObject* TitleBlackBlockPrefab::Create(GameObjectManager* mgr) {
...
void TitleBlackBlockPrefab::Configure(GameObject* obj) {
